...
PARAMETERS.isAllContextSearchAllowedForLearning = "false"
PARAMETERS.isAllContextSearchAllowedForExploitation = "false"
constrains.append(PARAMETERS.getConstainsLabelsAreYStrings(xLabelStrings, XYDevMinMax))
...
for lbl in varyingParamStrings:
    varyingParamStringsFinal.append("All Contexts "+lbl)
for lbl in varyingParamStrings:
    varyingParamStringsFinal.append("Neigh. Contexts "+lbl)
