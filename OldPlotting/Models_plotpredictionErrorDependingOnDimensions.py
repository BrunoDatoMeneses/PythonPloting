...
_PLOT.plotWithDeviationWithFillBetween(labelStrings, colors, intervalColors, markers, figName, xlabel, ylabel, logXScale, logYScale, xString, yString, deviationString, constrains, 1, 1, figSize)
_PLOT.plotWitMinMaxWithFillBetween(labelStrings, colors, intervalColors, markers, figName, xlabel, ylabel, logXScale, logYScale, xString, yString, minString, maxString, constrains, 1, 1, figSize)
