...
ylabel = 'NCS Execution Time Sums (ms)'
...
yStrings = ["NCS_UselessnessTimeExecution","NCS_IncompetendHeadTimeExecution","NCS_ConcurrenceAndConflictTimeExecution",
...
xLabelStrings = ["Useless.","Unprod.","Conf. and Conc.",
            "Creation","Redun.","Model Inac.","Other Inac."]
...
figName = "sca_23_NCS_" + yStringLong + "-" + PARAMETERS.getFigName() + figEndName
print(figName)
