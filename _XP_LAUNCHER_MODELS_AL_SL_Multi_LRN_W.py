...
# // PARAMS.model = "squareSplitFixed";
    ...
    listofAccuracyLearningWeight = ["1.0","0.5","0.5"]
    listofExperienceLearningWeight = ["0.5","1.0","0.5"]
    listofGeneralizatioLearningWeight = ["0.5","0.5","1.0"]

    listofProximityExploitationWeight = ["1.0","0.5","0.5"]
    listofExperienceExploitationWeight = ["0.5","1.0","0.5"]
    listofGeneralizatioExploitationWeight = ["0.5","0.5","1.0"]


    for accLrnW, expLrnW, genLrnW, proxExplW, expExplW, genExplW in zip(listofAccuracyLearningWeight,listofExperienceLearningWeight,listofGeneralizatioLearningWeight,
                                                                        listofProximityExploitationWeight,listofExperienceExploitationWeight,listofGeneralizatioExploitationWeight):
