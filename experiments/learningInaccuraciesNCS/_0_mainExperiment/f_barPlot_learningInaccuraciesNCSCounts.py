...
def generateFigures():
    ...
    yStrings = ["modelRequests", "conflictRequests", "concurrenceRequests", "voidRequests", "fusionRequests",
                "restructureRequests", "frontierRequests"]
    yStringsAvg = []
    yStringsDev = []
    yStringsMin = []
    yStringsMax = []
    ...
    xLabelStrings = ["Model Ambiguities", "Conflicts", "Concurrencies", "Incompetencies", "Complete Redundancy",
                     "Partial Redundancy", "Range Ambiguity"]
    logXScale = False
    logYScale = False
    XYDevMinMax = []
