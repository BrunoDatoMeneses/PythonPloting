...
yStrings = ["rdmRequests","modelRequests","conflictRequests","concurrenceRequests","voidRequests","fusionRequests","restructureRequests","frontierRequests"]
yStringsAvg = []
yStringsDev = []
yStringsMin = []
yStringsMax = []
...
xLabelStrings = ["Random Requests","Model Ambiguities", "Conflicts", "Concurrencies", "Incompetencies", "Complete Redundancy", "Partial Redundancy", "Range Ambiguities"]
