...
# // PARAMS.model = "squareSplitFixed";
    ...
    listofAccuracyLearningWeight = ["1.0","1.0", "0.5", "0.5"]
    listofExperienceLearningWeight = ["1.0","0.5", "1.0", "0.5"]
    listofGeneralizatioLearningWeight = ["1.0","0.5", "0.5", "1.0"]

    listofProximityExploitationWeight = ["1.0","1.0", "0.5", "0.5"]
    listofExperienceExploitationWeight = ["1.0","0.5", "1.0", "0.5"]
    listofGeneralizatioExploitationWeight = ["1.0","0.5", "0.5", "1.0"]

    for accLrnW, expLrnW, genLrnW, proxExplW, expExplW, genExplW in zip(listofAccuracyLearningWeight,
                                                                        listofExperienceLearningWeight,
                                                                        listofGeneralizatioLearningWeight,
                                                                        listofProximityExploitationWeight,
                                                                        listofExperienceExploitationWeight,
                                                                        listofGeneralizatioExploitationWeight):
        LEARNING_WEIGHT_ACCURACY = [accLrnW]
        LEARNING_WEIGHT_EXPERIENCE = [expLrnW]
        LEARNING_WEIGHT_GENERALIZATION = [genLrnW]

        EXPLOITATION_WEIGHT_PROXIMITY = [proxExplW]
        EXPLOITATION_WEIGHT_EXPERIENCE = [expExplW]
        EXPLOITATION_WEIGHT_GENERALIZATION = [genExplW]
