...
ylabel = 'Agents Cycles Time Sums (ms)'
...
yStrings = ["perceptsTimeExecution","contextsTimeExecution","NCS_PotentialRequestTimeExecution",
            ]
yStringsAvg = []
yStringsDev = []
yStringsMin = []
...
xLabelStrings = ["Percepts","Contexts","Head"]
...
varyingParamStrings = ["n = 2","n = 3","n = 5"]
dimensions = ["2","3"]
...
figName = "sca_235_cycles_" + yStringLong + "-" + PARAMETERS.getFigName() + figEndName
print(figName)
