...
ylabel = 'Scores'
yStringLong ="VolNBAgentGeneralization"
...
yStrings = ["mappingScore","nbAgents","generalizationScore"]
...
xLabelStrings = ["Volume of Agents", "Number of Agents", "Generalization Score"]
